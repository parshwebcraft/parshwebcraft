  ...
  const plans = [
    {
      ...
      name: "Starter",
      price: "₹7,999",
      subtitle: "Best for small local businesses and personal brands.",
      features: [
        "1–5 Pages",
        "Responsive Design",
    ...
    },
    {
      ...
      price: "₹14,999",
      subtitle: "Perfect for growing businesses, lead generation & branding.",
      popular: true,
      features: [
        "6–8 Pages",
        "Premium UI/UX + Animations",
        "Lead Forms & Funnels",
        "Advanced Speed & Security Setup",
        "Analytics & GMB Integration",
        "Menu / Services / Team Pages",
        "Free Hosting + Domain (1 Year)",
        "Delivery: 5–10 Days",
      ],
    },
    {
      ...
      price: "₹29,999+",
      subtitle: "Conversion-focused sites with CRM, booking or store.",
      features: [
        "10–15 Pages",
        "Conversion Optimized Landing Page",
        "Booking or E-commerce Integration",
        "Payment Gateway Setup",
        "Full Performance & SEO Setup",
    ...
    },
    {
      ...
      price: "Contact",
      subtitle: "Enterprise-level systems, apps, marketplaces & membership.",
      features: [
        "Custom Pages (12+)",
        "Advanced E-commerce / Courses / Memberships",
        "Custom Filters, APIs & Integrations",
        "Enterprise SEO & Brand Strategy",
        "SLA, Priority Support & Dedicated Hosting",
        "Advanced Analytics, Dashboards & Funnels",
